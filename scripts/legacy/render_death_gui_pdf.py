"""Render Death of GUI-API Divide AIS paper to PDF."""
...
md_path = (
    ...
    / "Documents"
    / "POCKET_Research"
    / "Death_of_GUI_API_Divide_AIS"
    / "THE_DEATH_OF_THE_GUI_API_DIVIDE.md"
)
...
class Paper(FPDF):
    def footer(self):
        ...
        self.cell(0, 8, f"INL-2026-POCKET.AIS.DEATH_GUI.001  |  Page {self.page_no()}", align="C")
